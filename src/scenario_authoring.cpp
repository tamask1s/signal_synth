...
namespace signal_synth
{
    ...
    std::string scenario_authoring_metadata_json()
    {
        ...
        output << "],\"targets\":["
               ...
               << "{\"id\":\"ppg_physiology_requires_ppg\",\"expression\":\"ppg.enabled || (ppg.pulse_delay_jitter_ms == 0 && ppg.low_frequency_amplitude_modulation_ratio == 0 && ppg.rise_time_variation_ratio == 0 && ppg.decay_time_variation_ratio == 0 && ppg.perfusion_episodes.length == 0)\",\"message\":\"PPG physiology controls require an enabled PPG channel.\"},"

...
| `TEST-ECG-REPOLARIZATION-001` | Ischemia, ST-T, and repolarization phenotypes and assertions | `teszt/ecg_repolarization_test.cpp` |
| `TEST-ECG-CONDUCTION-001` | Advanced conduction phenotypes, conflicts, severity, and sampled assertions | `teszt/ecg_conduction_test.cpp` |

...
| `TRC-HRV-PACK-001` | `REQ-HRV-SCN-001..006`, `REQ-HRV-GT-001..004`, `REQ-HRV-MET-001..005`, `REQ-HRV-SCORE-001..004` | HRV robustness v2, controlled VLF and pipeline diagnostics | `src/clinical_ecg.*`, `src/ecg_scenario.*`, `src/ecg_scenario_json.*`, `src/hrv_metrics.*`, `examples/packs/hrv_robustness_v2*`, `examples/scenarios/hrv/` | `TEST-HRV-PACK-001`, `TEST-ECG-PACK-001`, `TEST-HRV-METRICS-001`, `TEST-HRV-SCORING-001`, `TEST-PYTHON-SCORING-001` | [signal_synth#89](https://github.com/tamask1s/signal_synth/issues/89) |

...
source subset as strict C++11 and renders every maintained scenario embedded by
the integration scripts. Final UI inspection remains manual integration evidence.

...
int main()
{
    ...
    ok &= check(std::string(signal_synth::signal_synth_generator_version()) == "0.9.0-dev", "runtime_generator_version");
    ok &= check(std::string(signal_synth::signal_synth_package_contract_version()) == "synsigra_challenge_package_v3" && std::string(signal_synth::signal_synth_scoring_manifest_contract_version()) == "synsigra_scoring_manifest_v2" && std::string(signal_synth::signal_synth_verification_protocol_contract_version()) == "synsigra_verification_protocol_v1" && std::string(signal_synth::signal_synth_verifier_version()) == "0.9.0", "runtime_contract_versions");

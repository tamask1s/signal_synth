...
int main()
{
    ...
    ok &= check(rejects_without_mutation(std::string(input).replace(input.find("\"schema_version\":1"), 18, "\"schema_version\":5"), signal_synth::ecg_json_schema_version), "reject_schema_version");

...
int main()
{
    ...
    ok &= check(render.artifacts.size() == 12 && render.find_artifact("waveform.csv") && render.find_artifact("annotations.json") && render.find_artifact("report.html") && render.find_artifact("synsigra.hea"), "render_artifacts");

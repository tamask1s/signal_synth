...
int main()
{
    ...
    ok &= check(std::string(signal_synth::synsigra_integration_contract_version()) == "synsigra_core_integration_v7"
        ...
        && integration_contract.find("\"python_verifier\":\"0.13.0\"") != std::string::npos
        ...
        && integration_contract.find("\"verification_protocol\":\"synsigra_verification_protocol_v2\"") != std::string::npos
        ...
        && integration_contract.find("\"measurement_targets\":[\"rr_interval\",\"qtc\",\"hrv\",\"morphology_assertions\",\"ecg_ppg_alignment\",\"ppg_optical\",\"prv\",\"respiratory_rate\",\"rhythm_burden\"]") != std::string::npos, "integration_contract");
    ...
    ok &= check(std::string(signal_synth::synsigra_api_version()) == "1.5.0", "api_version");

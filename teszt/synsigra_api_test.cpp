...
int main()
{
    ...
    ok &= check(render.artifacts.size() == 15 && render.find_artifact("waveform.csv") && render.find_artifact("annotations.json") && render.find_artifact("report.html") && render.find_artifact("synsigra.hea") && render.find_artifact("synsigra.edf") && render.find_artifact("synsigra.bdf"), "render_artifacts");

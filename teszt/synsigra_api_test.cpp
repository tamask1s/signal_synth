...
int main()
{
    ...
    ok &= check(render.artifacts.size() == 8 && render.find_artifact("waveform.csv") && render.find_artifact("annotations.json") && render.find_artifact("report.html"), "render_artifacts");

...
int main()
{
    ...
    ok &= check(first.fingerprint() == second.fingerprint() && first.schema_version() == 2 && signal_synth::ecg_scenario_engine_version() == 14, "fingerprint_is_order_independent_and_versioned");
    ...
    signal_synth::ecg_qa_scenario left_anterior_fascicular;
    left_anterior_fascicular.add_condition(signal_synth::ecg_condition_lafb);
    signal_synth::ecg_qa_scenario incomplete_right_bundle;
    incomplete_right_bundle.add_condition(signal_synth::ecg_condition_irbbb);
    signal_synth::ecg_qa_scenario nonspecific_ivcd;
    nonspecific_ivcd.add_condition(signal_synth::ecg_condition_ivcd);
    signal_synth::ecg_qa_scenario left_posterior_fascicular;
    left_posterior_fascicular.add_condition(signal_synth::ecg_condition_lpfb);
    signal_synth::ecg_qa_scenario preexcitation;
    preexcitation.add_condition(signal_synth::ecg_condition_wpw);
    signal_synth::ecg_qa_scenario incomplete_left_bundle;
    incomplete_left_bundle.add_condition(signal_synth::ecg_condition_ilbbb);
    ok &= check(generated_phenotype_passes(engine, first_degree_assertions) && generated_phenotype_passes(engine, prolonged_pr) && generated_phenotype_passes(engine, mobitz_i) && generated_phenotype_passes(engine, mobitz_ii) && generated_phenotype_passes(engine, complete_block) && generated_phenotype_passes(engine, right_bundle) && generated_phenotype_passes(engine, left_bundle) && generated_phenotype_passes(engine, long_qt) && generated_phenotype_passes(engine, left_anterior_fascicular) && generated_phenotype_passes(engine, incomplete_right_bundle) && generated_phenotype_passes(engine, nonspecific_ivcd) && generated_phenotype_passes(engine, left_posterior_fascicular) && generated_phenotype_passes(engine, preexcitation) && generated_phenotype_passes(engine, incomplete_left_bundle) && generated_phenotype_passes(engine, tachy_block), "conduction_phenotype_assertions");

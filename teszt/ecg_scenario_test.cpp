...
int main()
{
    ...
    ok &= check(first.fingerprint() == second.fingerprint() && first.schema_version() == 2 && signal_synth::ecg_scenario_engine_version() == 15, "fingerprint_is_order_independent_and_versioned");

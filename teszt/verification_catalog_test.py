...
def main():
    ...
    expected = set([
        ...
        "wearable_timebase_v2", "ppg_benchmark_v1", "ppg_optical_v2", "ecg_delineation_v2", "cardiorespiratory_v1",
    ])
    seen = set()
    for entry in catalog["packs"]:
        ...
        assert entry["release_date"] == ("2026-07-17" if pack_id in ("ecg_delineation_v2", "wearable_timebase_v2", "ppg_optical_v2", "cardiorespiratory_v1") else "2026-07-06")

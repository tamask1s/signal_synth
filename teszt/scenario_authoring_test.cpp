...
int main()
{
    ...
    ok &= check(std::string(signal_synth::scenario_authoring_metadata_version()) == "synsigra_authoring_v13"
        ...
        && metadata.find("\"path\":\"$.physiology.ppg_delay_modulation_ms\"") != std::string::npos
        && metadata.find("\"path\":\"$.physiology.accelerometer_respiration_amplitude_g\"") != std::string::npos
    ...
    ok &= check(signal_synth::scenario_target_support_for_name("r_peak") == signal_synth::scenario_target_local_scoring
        ...
        && signal_synth::scenario_target_support_for_name("prv") == signal_synth::scenario_target_local_scoring
        && signal_synth::scenario_target_support_for_name("respiratory_rate") == signal_synth::scenario_target_local_scoring

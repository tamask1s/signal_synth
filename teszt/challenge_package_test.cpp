...
int main()
{
    ...
    ok &= check(signal_synth::challenge_file_role_for_export_artifact("synsigra.hea") == signal_synth::challenge_file_wfdb_header && signal_synth::challenge_file_role_for_export_artifact("synsigra.edf") == signal_synth::challenge_file_edf && signal_synth::challenge_file_role_for_export_artifact("case_summary.json") == signal_synth::challenge_file_metadata_json && signal_synth::challenge_file_role_for_export_artifact("resolved_scenario.json") == signal_synth::challenge_file_metadata_json && signal_synth::challenge_file_role_for_export_artifact("randomization.json") == signal_synth::challenge_file_metadata_json, "artifact_role_mapping");

...
int main()
{
    ...
    ok &= check(project.find("ecg_render.cpp") != std::string::npos && project.find("hrv_metrics.cpp") != std::string::npos && project.find("scenario_stress.cpp") != std::string::npos, "codeblocks_generation_dependencies");
